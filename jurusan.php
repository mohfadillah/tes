                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="return confirm('Apakah anda yakin menghapus data ini??')" href="tambah-jurusan.php?delete=<?php echo $dataJurusan ['id'] ?>" class="btn btn-danger btn-sm">Hapus</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
