...
function getPeserta($koneksi, $status)
{
    ...
    if (!in_array($status, $array_status)) {
        $query = mysqli_query($koneksi, "SELECT * FROM pendaftran WHERE status $status AND deleted= 0 ");
    } else {
        $query = mysqli_query($koneksi, "SELECT * FROM pendaftran WHERE status = '$status' AND deleted = 0");
    }
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Calon Peserta</h1>
